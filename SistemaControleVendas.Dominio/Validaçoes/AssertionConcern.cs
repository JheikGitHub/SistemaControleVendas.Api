...
namespace SistemaControleVendas.Dominio.Validaçoes
{
    public class AssertionConcern
    {
        ...
        public static void AssertArgumentRange(double value, double minimum, string message)
        {
            if (value < minimum)
            {
                throw new InvalidOperationException(message);
        ...
        public static void AssertArgumentRange(int value, int minimum, string message)
        {
            if (value < minimum)
            {
                throw new InvalidOperationException(message);
        ...
        {
            AssertionConcern.AssertArgumentRange(value, minimum, message);
        }
